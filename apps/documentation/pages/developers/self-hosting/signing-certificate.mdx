...
description: Learn how to generate or buy a signing certificate for your Smartsign instance.
---
...
Self-hosting your Smartsign instance requires your own certificate to sign documents. [This article](https://smartbill.co.il/blog/building-documenso-pt1) explains why.
...
Receiving your signing certificate is similar to receiving an SSL certificate. Since you need the actual certificate as part of the Smartsign config, you must generate a secret private key and a CSR (Certificate Signing Request).
...
### Configure Smartsign to use the certificate
