---
title: How to Self-Host Smartsign
description: Learn how to self-host Smartsign on your server or cloud infrastructure using Docker or other deployment methods.
---
...
The following guide will walk you through setting up Smartsign manually on your server or cloud infrastructure.
...
<Callout type="info">
  If you use a reverse proxy in front of Smartsign, don't forget to provide the public URL for the
...
The following guide will walk you through setting up Smartsign using Docker. You can choose between a Docker Compose production setup or a standalone container.

We provide a Docker container for Smartsign, published on both DockerHub and GitHub Container Registry.
...
This setup includes a PostgreSQL database and the Smartsign application. You will need to provide your own SMTP details using environment variables.

<Steps>

### Download the Docker Compose File

Download the Docker Compose file from the Smartsign repository - [compose.yml](https://raw.githubusercontent.com/documenso/documenso/release/docker/production/compose.yml).
...
The command will start the PostgreSQL database and the Smartsign application containers.

### Access the Application

Access the Smartsign application by visiting `http://localhost:3000` in your web browser.

</Steps>

### Option 2: Standalone Docker Container

If you prefer to host the Smartsign application on a specific container provider, use the pre-built Docker image from DockerHub or GitHub's Package Registry. You will need to provide your own database and SMTP host.

<Steps>

### Pull the Docker Image

Pull the Smartsign Docker image from DockerHub:
...
You can access the Smartsign application by visiting the URL you provided for the `NEXT_PUBLIC_WEBAPP_URL` environment variable in your web browser.

</Steps>

### Advanced Configuration

The environment variables listed above are a subset of those available for configuring Smartsign. The table below provides a complete list of environment variables and their descriptions.

| Variable                                     | Description                                                                                         |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `PORT`                                       | The port on which the Smartsign application runs. It defaults to `3000`.                            |
...
We offer several alternative deployment methods for Smartsign if you need more options.
