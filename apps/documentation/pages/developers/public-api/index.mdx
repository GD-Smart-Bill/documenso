---
title: Public API
description: Learn how to interact with your documents programmatically using the Smartsign public API.
---
...
Smartsign provides a public REST API enabling you to interact with your documents programmatically. The API exposes various HTTP endpoints that allow you to perform operations such as:
...
Check out the [API V1 documentation](https://sign.smartbill.co.il/api/v1/openapi) for details about the API endpoints, request parameters, response formats, and authentication methods.
