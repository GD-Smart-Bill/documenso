...
description: Learn how to set up Smartsign for local development.
---

# Local development

There are multiple ways of setting up Smartsign for local development. At the moment of writing this documentation, there are 3 ways of running Smartsign locally:
