---
title: Manual Setup
description: Manually set up Smartsign on your machine for local development.
---
...
Follow these steps to set up Smartsign on your local machine:

<Steps>

### Fork Smartsign

Fork the [Smartsign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
