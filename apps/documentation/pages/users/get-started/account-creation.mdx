...
description: Learn how to create an account on Smartsign.
---
...
The first step to start using Smartsign is to pick a plan and create an account. At the moment of writing this guide, we have 3 plans available: Free, Individual, and Teams.
...
You can claim a premium username by upgrading to a paid plan. After upgrading to a paid plan, you can update your [public profile](https://sign.smartbill.co.il/settings/public-profile).
