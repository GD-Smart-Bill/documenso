---
title: Teams
description: Learn how to create and manage teams in Smartsign.
---
...
Smartsign allows you to create teams to collaborate with others on creating and signing documents.
...
![Smartsign account dropdown menu](/get-started-images/add-team.webp)
...
```bash
https://sign.smartbill.co.il/t/<your-team-name>
```

![Smartsign create team modal](/get-started-images/add-team-2.webp)
...
```bash
https://sign.smartbill.co.il/t/<your-team-name>/settings/members
```
...
![Invite team members in Smartsign dashboard](/get-started-images/add-team-members-documenso.webp)
...
| Email address                | Role    |
| ---------------------------- | ------- |
| team-admin@smartbill.co.il   | Admin   |
| team-manager@smartbill.co.il | Manager |
| team-member@smartbill.co.il  | Member  |
...
```bash
https://sign.smartbill.co.il/t/<your-team-name>/settings
```

### [Send your First Document](https://sign.smartbill.co.il/)
