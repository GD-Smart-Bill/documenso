...
![Template page in the Smartsign dashboard](/direct-links/document-direct-link-documenso.webp)
...
![Enable the document direct link in the Smartsign dashboard](/direct-links/enable-document-direct-link-modal.webp)
...
```bash
https://sign.smartbill.co.il/d/<random-generated-string>
```

### Optional: Add Templates to Your Profile

You can add templates with direct links to your public [Smartsign profile](/users/profile) to make them signable anytime.
