---
title: User Profile
description: Learn how to set up your public profile on Smartsign.
---
...
Smartsign allows you to create a public profile to share your templates for anyone to sign. This is useful for distributing and collecting signatures for commonly used documents, making it more efficient for both the document creator and the signers.

<Callout type="info">A free Smartsign account gives you 5 free signatures per month.</Callout>
...
```bash
https://sign.smartbill.co.il/p/<username>
```
...
![An example of a public profile on Smartsign](/direct-links/documenso-profile.webp)

The image above shows an example of a public profile on Smartsign.
